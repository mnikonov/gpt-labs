...
public static class SystemThemeHelper
{
    ...
    {
        var theme = ApplicationSettings.Instance.AppTheme switch
        {
            ElementTheme.Default => Application.Current.RequestedTheme == ApplicationTheme.Dark ? ElementTheme.Dark : ElementTheme.Light,
            _ => ApplicationSettings.Instance.AppTheme,
        };
